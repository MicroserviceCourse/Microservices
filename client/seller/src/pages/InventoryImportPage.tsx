          ...
          <tbody>
            {loading ? (
              ...
              products.map((p) => {
                ...
                const isError = isChecked && qty !== undefined && qty <= 0;
                return (
                  <tr
                    key={p.id}
                  ...
                  >
                    ...
                    <td className="p-3 flex items-center gap-3">
                      <img src={p.thumbnailUrl} className="w-10 h-10 rounded-lg object-cover" />
                    ...
                    <td className="p-3 text-center">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          updateQty(p.id, value === "" ? undefined : Number(value));
                        }}
                        className={`w-30 text-center rounded-md py-1.5 px-2 text-sm border-0 ring-1 ring-inset ${
                          isError
      ...
      <div className="flex flex-col md:flex-row gap-6  pt-6">
        ...
        <div className="flex-1">
          <label className="block text-sm font-medium text-gray-900">
            Import Note
            <span className="ml-2 text-gray-500 font-normal">(Applied to all selected items)</span>
          </label>
        ...
        bg-gray-50 outline-none"
            />
            <div className="absolute bottom-2 right-2 text-xs text-gray-400">{note.length}/500</div>
          </div>
        </div>
        ...
        <div className="w-full md:w-64 flex flex-col items-end gap-4">
          ...
          <div className="flex items-center gap-2 mt-7">
            <span className="text-sm text-gray-500 whitespace-nowrap">Total Selected:</span>
