      ...
      <div className="sticky top-6">
        ...
        >
          <div className="flex flex-col gap-4">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">Media Details</h2>
          ...
          <div className="flex flex-col gap-4 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-slate-800 dark:text-slate-200">{active.size}</span>
            </div>
