              ...
              {section.items.map((item, j) => {
                ...
                return (
                  <li key={j}>
                    ...
                    <div
                      onClick={() =>
                        item.children ? toggleMenu(id) : handleNavigate(item.path)
                      }
      ...
      <div className="mt-8 border-t border-[#f2f7fb] pt-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          {[Facebook, Twitter, Linkedin, Instagram].map((Icon, index) => (
            <button
              key={index}
              className="p-2 bg-gray-50 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition"
            >
              <Icon size={18} />
            </button>
          ))}
        ...
        <div className="border border-gray-100 rounded-2xl p-4 text-center shadow-sm hover:shadow-md transition">
          ...
          <p className="text-sm text-gray-500 mt-1 mb-4">
            Contact us if you need any assistance. We will reach out as soon as
            possible.
          </p>
